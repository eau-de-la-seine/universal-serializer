 ...
 *  @generated
 */
package fr.ekinci.universalserializer.test.thrift;
...
public class ThriftComplexTestClass implements org.apache.thrift.TBase<ThriftComplexTestClass, ThriftComplexTestClass._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftComplexTestClass> {
  ...
  public java.lang.String attr8; // required
  public java.lang.String attr9; // required
  public java.util.List<java.lang.Double> attr10; // required
  public java.util.List<java.lang.String> attr11; // required
  ...
  public ThriftComplexTestClass(
    ...
    java.util.List<java.lang.Double> attr10,
    java.util.List<java.lang.String> attr11,
  ...
  public ThriftComplexTestClass(ThriftComplexTestClass other) {
    ...
    if (other.isSetAttr10()) {
      java.util.List<java.lang.Double> __this__attr10 = new java.util.ArrayList<java.lang.Double>(other.attr10);
      this.attr10 = __this__attr10;
    }
    if (other.isSetAttr11()) {
      java.util.List<java.lang.String> __this__attr11 = new java.util.ArrayList<java.lang.String>(other.attr11);
  ...
  public ThriftComplexTestClass setAttr8(java.lang.String attr8) {
    this.attr8 = attr8;
    return this;
  }
  ...
  public ThriftComplexTestClass setAttr9(java.lang.String attr9) {
    this.attr9 = attr9;
    return this;
  }
  ...
  public java.util.Iterator<java.lang.Double> getAttr10Iterator() {
    return (this.attr10 == null) ? null : this.attr10.iterator();
  }

  public void addToAttr10(double elem) {
    if (this.attr10 == null) {
      this.attr10 = new java.util.ArrayList<java.lang.Double>();
    }
    this.attr10.add(elem);
  }

  public java.util.List<java.lang.Double> getAttr10() {
    return this.attr10;
  }

  public ThriftComplexTestClass setAttr10(java.util.List<java.lang.Double> attr10) {
    this.attr10 = attr10;
    return this;
  }
  ...
  public java.util.Iterator<java.lang.String> getAttr11Iterator() {
    return (this.attr11 == null) ? null : this.attr11.iterator();
  }

  public void addToAttr11(java.lang.String elem) {
    if (this.attr11 == null) {
      this.attr11 = new java.util.ArrayList<java.lang.String>();
    }
    this.attr11.add(elem);
  }

  public java.util.List<java.lang.String> getAttr11() {
    return this.attr11;
  }

  public ThriftComplexTestClass setAttr11(java.util.List<java.lang.String> attr11) {
    this.attr11 = attr11;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ATTR2:
      if (value == null) {
        ...
        setAttr2((java.lang.Short)value);
      }
      break;
    ...
    case ATTR3:
      if (value == null) {
        ...
        setAttr3((java.lang.Integer)value);
      }
      break;
    ...
    case ATTR5:
      if (value == null) {
        ...
        setAttr5((java.lang.Double)value);
      }
      break;
    ...
    case ATTR6:
      if (value == null) {
        ...
        setAttr6((java.lang.Double)value);
      }
      break;
    ...
    case ATTR7:
      if (value == null) {
        ...
        setAttr7((java.lang.Boolean)value);
      }
      break;
    ...
    case ATTR8:
      if (value == null) {
        ...
        setAttr8((java.lang.String)value);
      }
      break;
    ...
    case ATTR9:
      if (value == null) {
        ...
        setAttr9((java.lang.String)value);
      }
      break;
    ...
    case ATTR10:
      if (value == null) {
        ...
        setAttr10((java.util.List<java.lang.Double>)value);
      }
      break;
    ...
    case ATTR11:
      if (value == null) {
        ...
        setAttr11((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int compareTo(ThriftComplexTestClass other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr1()).compareTo(other.isSetAttr1());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr2()).compareTo(other.isSetAttr2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr2()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr3()).compareTo(other.isSetAttr3());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr3()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr4()).compareTo(other.isSetAttr4());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr4()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr5()).compareTo(other.isSetAttr5());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr5()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr6()).compareTo(other.isSetAttr6());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr6()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr7()).compareTo(other.isSetAttr7());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr7()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr8()).compareTo(other.isSetAttr8());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr8()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr9()).compareTo(other.isSetAttr9());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr9()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr10()).compareTo(other.isSetAttr10());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr10()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr11()).compareTo(other.isSetAttr11());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr11()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr12()).compareTo(other.isSetAttr12());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr12()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAttr13()).compareTo(other.isSetAttr13());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAttr13()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ThriftComplexTestClass(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr10 = new java.util.ArrayList<java.lang.Double>(_list0.size);
                double _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr11 = new java.util.ArrayList<java.lang.String>(_list3.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftComplexTestClass struct) throws org.apache.thrift.TException {
      ...
      if (struct.attr11 != null) {
        oprot.writeFieldBegin(ATTR11_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter10 : struct.attr11)
          {
      ...
      if (struct.isSetAttr11()) {
        {
          ...
          for (java.lang.String _iter13 : struct.attr11)
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.attr10 = new java.util.ArrayList<java.lang.Double>(_list15.size);
          double _elem16;
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.attr11 = new java.util.ArrayList<java.lang.String>(_list18.size);
